...
mod tests {
    use super::super::{
        domain::{parse_vec_field, find_annotated_struct, find_score_type, DomainModel, EntityInfo, FactInfo},
        mod_rewriter::{extract_types, extend_tuple, insert_mod_decl_assemble},
        skeleton::{Pattern, generate_skeleton},
        utils::{validate_name, snake_to_title},
    };
    ...
    fn test_find_annotated_struct() {
        ...
        assert_eq!(find_annotated_struct(src, "planning_solution"), Some("EmployeeSchedule".to_string()));
    }
