pub const RUNTIME_CRATE_VERSION: &str = "0.15.0";
pub const UI_CRATE_VERSION: &str = "0.6.5";
pub const MAPS_CRATE_VERSION: &str = "2.1.4";

pub const RUNTIME_TARGET_LABEL: &str = "solverforge 0.15.0";
pub const UI_TARGET_LABEL: &str = "solverforge-ui 0.6.5";
pub const MAPS_TARGET_LABEL: &str = "solverforge-maps 2.1.4";
pub const RUNTIME_TARGET_DISPLAY: &str = "SolverForge crate target 0.15.0";
pub const RUNTIME_SOURCE_PATH: &str = "crates.io: solverforge 0.15.0";
